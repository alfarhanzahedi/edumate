...
from .views import UserProfileChangeView
...
urlpatterns = [
    ...
    path('<str:username>/update/', UserProfileChangeView.as_view(), name = 'user_profile_change'),
]
